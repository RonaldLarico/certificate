...
import ImageUploader from '@/components/modulos/rizo/ImageFrom';
  ...
  return (
    <section className='bg-[#1C004C]/70 min-h-screen pb-20'>
      ...
      <div className="p-10 ml-40 font-mono text-3xl hover:scale-110 duration-300">
        ...
        <Link href="/modulePdf/rizoPdf" className={`flex p-10 mr-40 font-mono text-3xl hover:scale-110 duration-300 ${!excelLoaded ? 'pointer-events-none' : ''}`}>
          <button className={`bg-[#6D0083]/70 px-10 py-3 text-white rounded-xl uppercase ${!excelLoaded || buttonDisabled ? 'opacity-50' : ''}`} disabled={buttonDisabled}>
