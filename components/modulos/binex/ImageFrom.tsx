...
import { openDatabase }  from '@/components/modulos/binex/database/index';
    ...
    if (ctx) {
      ...
      image.onload = async () => {
        ...
        if (selectedData && Array.isArray(selectedData.nombres) && Array.isArray(selectedData.codigo)) {
          ...
          const actividadAcademicaMaxWidth = 3000;
          ...
          const maxWidthh = 950;
          const fontSize = 42;
          const lineHeightt = 50;
          const x = canvas.width / 6.6;
          let yy = canvas.height / 3.7;
          let words;
