    ...
    if (ctx) {
      ...
      image.onload = async () => {
        ...
        if (selectedData && Array.isArray(selectedData.nombres) && Array.isArray(selectedData.codigo)) {
          ...
          const maxWidthNombre = 2500; // Ancho máximo para el nombre
          const initialNombreFontSize = 92;
          ...
          const actividadAcademicaMaxWidth = 3000; // Ancho máximo para la actividad académica
            if (selectedData.actividadAcademica !== null) {
              ...
              if (actividadAcademicaWidth > actividadAcademicaMaxWidth) {
                  ...
                  const fontSize = 85 * scaleFactor;
                  ctx.font = `bold ${fontSize}px Century Gothic`;
              } else {
                  ctx.font = 'bold 80px Century Gothic'; // Tamaño de fuente normal
              }
          ...
          const maxWidthh = 950; // Ancho máximo permitido
          const fontSize = 42; // Tamaño de fuente
          const lineHeightt = 50; // Altura de línea
          ...
          const textYPx = 2835;
          ctx.fillStyle = 'black';
          ctx.font = `bold 46px Century Gothic`;
