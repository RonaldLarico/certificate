    ...
    <Body style={main}>
      <Container style={container}>
        <Section style={content}>
          ...
          <Text style={paragraph}>
            ¡Felicidades por completar su diplomado sorrespondiente
            con éxito! <br />
            Adjunto a este correo encontrarás sus certificados oficiales de los módulos.
          </Text>
          <br />
            <strong>
              {dataString &&
          ...
          {/* <Row>
            <Column style={headerContent}>
              <Text style={headerContentSubtitle}>
                Adjuntamos tu Certificado y Materiales del Curso de{" "}
      ...
      <Section style={footer}>
        <Text style={footerText}>
          ...
          para el destinatario. Si has recibido este correo por error, por favor
          notifícanos inmediatamente y elimínalo.
        </Text>
